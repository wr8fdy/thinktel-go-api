...
// ThinkteluControlAPIDataContractsNumberPortOrderFormV2 Telephone numbers port-in request form. Contains the common elements for all port-in requests.
//
// swagger:model Thinktel.uControl.Api.DataContracts.NumberPortOrderFormV2
type ThinkteluControlAPIDataContractsNumberPortOrderFormV2 struct {
	...
	// Current provider (aka losing carrier). Required if CurrentReseller is null. Integer must be an ID listed in the GET /NumberPorts/Providers response.
	...
	// Current reseller. Required if CurrentProvider is null.
	...
	// Is there a PRI or Megalink Circuit #.
	IsPRIMegaLink bool `json:"IsPRIMegaLink,omitempty"`
	...
	// The PRI or Megalink Circuit #
	PRIMegalinkCircuit string `json:"PRIMegalinkCircuit,omitempty"`

	// Should the PRI or Megalink Circuit remain active?
	PRIMegalinkRemainActive bool `json:"PRIMegalinkRemainActive,omitempty"`
...
// Validate validates this thinktel u control Api data contracts number port order form v2
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateCustomerAccountNumber(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateCustomerCity(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateCustomerCountry(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateCustomerName(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateCustomerPostalCode(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateCustomerProvince(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateCustomerStreetName(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateCustomerStreetNumber(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateEmailAddress(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateExtraDetails(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateFileBlifSpreadsheet(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateFileLastInvoice(formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) validateFileLetterOfAuthorization(formats strfmt.Registry) error {
...
// ContextValidate validate this thinktel u control Api data contracts number port order form v2 based on the context it is used
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) contextValidateExtraDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) contextValidateFileBlifSpreadsheet(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) contextValidateFileLastInvoice(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) contextValidateFileLetterOfAuthorization(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ThinkteluControlAPIDataContractsNumberPortOrderFormV2) UnmarshalBinary(b []byte) error {
	var res ThinkteluControlAPIDataContractsNumberPortOrderFormV2
